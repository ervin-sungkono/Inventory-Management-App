...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String FIELD_USER_PROFILE_PIC = "profile_pic";

    // Item Table Columns
    private static final String FIELD_ITEM_ID = "id";
    private static final String FIELD_FOREIGN_USER_ID = "user_id";
    private static final String FIELD_ITEM_NAME = "name";
    private static final String FIELD_ITEM_DESC = "description";
    private static final String FIELD_ITEM_QTY = "quantity";
    private static final String FIELD_ITEM_IMAGE = "image";
